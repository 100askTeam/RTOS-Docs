...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image1.png) 
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image2.png)  

### 5.3.2 STM32CubeMX配置

LED使用PC13引脚，配置如下：

![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image3.png)  
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image4.png)  

### 5.4.2 STM32CubeMX配置

OLED屏幕使用I2C1通道，I2C1使用PB6、PB7作为SCL、SDA引脚，配置如下：

![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image5.png)  
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image6.png)  
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image7.png)  
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image8.png)  
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image9.png)  
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image10.png)  
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image11.png)  

### 5.8.2 STM32CubeMX配置

DHT11使用PA1，初始状态为“open drain，pull-up”，如下图：

![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image12.png)  
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image13.png)  

### 5.9.2 STM32CubeMX配置

DS18B20使用PA1，初始状态为“open drain，pull-up”，如下图：

 ![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image14.png)
...
将红外避障模块接到配套的DShanMCU-F103 Base Board学习底板上即可，具体位置是印有“红外对管避障模块” 丝印的排母接口，如下图所示：
 ...
 ![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image15.png) 

### 5.10.2 STM32CubeMX配置

红外避障模块使用PB13，把它配置为输入引脚即可，如下图：

![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image16.png) 
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image17.png) 

### 5.11.2 STM32CubeMX配置

超声测距模块SR04使用PB9最为Trig引脚，使用PB8作为Echo引脚。把PB9设置为输出、把PB8设置为输入即可。如下图所示：

![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image18.png) 
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image19.png) 
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image20.png) 

PB12:

![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image21.png) 
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image22.png) 

### 5.13.2 STM32CubeMX配置

红外接收模块使用PB10作为中断引脚，双边沿触发。要使能内部上拉，因为没有外部上拉电阻。配置如下：

![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image23.png) 
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image24.png) 
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image27.png) 

### 5.16.2 STM32CubeMX配置

光敏电阻模块使用PA3作为ADC引脚，配置如下：

![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image28.png) 
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image29.png) 

### 5.18.2 STM32CubeMX配置

陀螺仪使用I2C1通道，I2C1使用PB6、PB7作为SCL、SDA引脚，配置如下：

![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image30.png) 
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image31.png)  
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image32.png)  

PB9配置如下图所示：

![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image33.png)  
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image34.png)  
...
![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image35.png)  

PB4配置为PWM引脚（TM3_CHN1），如下图所示：

![](D:\工作文件\第5章 模块使用说明与STM32CubeMX配置\images\image36.png)  
